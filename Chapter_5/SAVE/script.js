...
const player = {
    ...
    holdLeft: 0, holdRight: 0, runThreshold: 40, runningSpeedMultiplier: 1.8,
};
...
function initEnemies() {
    ...
    boss = {
        type: 'Dragon',
        x: 600, y: 150, velY: 0, width: 200, height: 200,
        ...
        idleFrames: 0, walkFrames: 4, attack1Frames: 8, hurtFrames: 0, deadFrames: 5,
    ...
    boss.imgWalk.src = `assets/Dragon/Walk.jpg`;
    boss.imgAttack1.src = `assets/Dragon/Attack_1.jpg`;
    ...
    if (boss.frameTimer >= boss.frameInterval) {
        ...
        if (boss.state === 'attack1' && boss.currentFrame === 5) {
            ...
            targets.forEach(t => {
                ...
                let tDist = Math.abs(tCenterX - bossCenterX);
                
                if (tDist <= 220 && tDist >= 30 && t.y > boss.y - 50) {
                   if (t === player) {
