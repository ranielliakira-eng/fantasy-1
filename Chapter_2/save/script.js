...
casa4_1Img.src = 'assets/Battleground/casa/casa4_1.png';

const casa5Img = new Image();
casa5Img.src = 'assets/Battleground/casa/casa5.png';
...
// NPCs
const farmerNpc = {
    x: 1250, y: 105, width: 80, height: 90, imgIdle: new Image(),
...
if (player.x > 6400 && !boss) {
    boss = {
        ...
        idleFrames: 6, walkFrames: 7, attackFrames: 10, hurtFrames: 4, deadFrames: 4,
...
function draw() {
    ...
    if (gameState === 'playing') {
        ...
        if (boss && boss.hp > 0) {
            ...
            ctx.fillText("WIZARD POSSUÍDO", canvas.width/2, 35);
        }
    }
